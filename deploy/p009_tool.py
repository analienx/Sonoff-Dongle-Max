...
# Install structured version/health/manifest proof first, then bind the complete
# resulting snapshot operation to one uninterrupted Docker owner/start epoch.
p009_version.install()
p009_ownerproof.install()
